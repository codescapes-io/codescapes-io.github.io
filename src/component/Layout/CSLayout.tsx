...
const CSILayout: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const resp = await axios.get<CSIDocDefaultIndexResponse>(
                `${process.env.REACT_APP_BASE_URL}/api/default-doc-id`
            );
    ...
    return (
        <>
            <nav title="navbar">
                ...
                <Box title="menu-icon" sx={{ display: { md: 'none' }, m: '32px' }} onClick={handleClick}>
                    <CSMenuIcons />
                </Box>
            </nav>
            <Drawer title="side-drawer" anchor="right" open={bDrawerOpen} onClose={handleClose}>
                <Box
                    sx={{
                        width: 200,
                        height: '100%',
                ...
                >
                    <List>
                        ...
                        >
                            <NavLink className="sidebar-anchor" onClick={handleClose} to="/">
                                HOME
                            </NavLink>
                        </ListItem>
                        <ListItem
                        ...
                        >
                            <NavLink className="sidebar-anchor" onClick={handleClose} to="/docs">
                                DOCS
                            </NavLink>
                        </ListItem>
                        <ListItem
                        ...
                        >
                            <NavLink className="sidebar-anchor" onClick={handleClose} to="/pricing">
                                PRICING
                            </NavLink>
                        </ListItem>
                        <ListItem
                        ...
                        >
                            <NavLink className="sidebar-anchor" onClick={handleClose} to="/blog">
                                BLOG
                            </NavLink>
                        </ListItem>
                    </List>
            ...
            <Routes>
                ...
                <Route
                    path="/docs"
                    element={path === '#/docs' ? <Navigate to={`/docs/${nDefIndex}`} /> : <CSDocsPage />}
                >
